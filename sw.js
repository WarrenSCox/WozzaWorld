const CACHE='wozzaworld-v07';
const LOCAL=['./','./index.html','./styles.css?v=0.7','./app.js?v=0.7','./manifest.webmanifest?v=0.7','./icon.svg?v=0.7','./icon-192.png?v=0.7','./icon-512.png?v=0.7'];
