const CACHE='wozzaworld-0.19.1-logo-swap';
const LOCAL=['./','./index.html','./styles.css?v=0.18.91-runtime-fix','./cities-data.js?v=0.17.2','./app.js?v=0.18.91-runtime-fix','./manifest.webmanifest?v=0.16.8','./icon-192.png?v=0.16.8','./icon-192.png?v=0.16.8','./icon-512.png?v=0.16.8','./wozzaworld-logo.png?v=0.19.1','./cloud-a.svg?v=0.16.8','./cloud-b.svg?v=0.16.8'];
