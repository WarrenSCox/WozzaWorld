const CACHE='wozzaworld-v0.15.9';
const LOCAL=['./','./index.html','./styles.css?v=0.15.9','./app.js?v=0.15.9','./manifest.webmanifest?v=0.15.9','./icon-192.png?v=0.15.9','./icon-192.png?v=0.15.9','./icon-512.png?v=0.15.9','./wozzaworld-logo.png?v=0.15.9','./cloud-a.svg?v=0.15.9','./cloud-b.svg?v=0.15.9'];
