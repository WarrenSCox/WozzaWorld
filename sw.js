const CACHE='wozzaworld-v0.14.9';
const LOCAL=['./','./index.html','./styles.css?v=0.14.9','./app.js?v=0.14.9','./manifest.webmanifest?v=0.14.9','./icon.svg?v=0.14.9','./icon-192.png?v=0.14.9','./icon-512.png?v=0.14.9','./wozzaworld-logo.png?v=0.14.9'];
