const CACHE='wozzaworld-0.19.3-brand-system';
const LOCAL=['./','./index.html','./styles.css?v=0.19.3','./cities-data.js?v=0.17.2','./app.js?v=0.18.91-runtime-fix','./manifest.webmanifest?v=0.19.3','./icon-192.png?v=0.19.3','./icon-192.png?v=0.19.3','./icon-512.png?v=0.19.3','./wozzaworld-banner-logo.png?v=0.19.3','./wozzaworld-startup-logo.png?v=0.19.3','./cloud-a.svg?v=0.16.8','./cloud-b.svg?v=0.16.8'];
