const CACHE='wozzaworld-v0.15.6';
const LOCAL=['./','./index.html','./styles.css?v=0.15.6','./app.js?v=0.15.6','./manifest.webmanifest?v=0.15.6','./icon-192.png?v=0.15.6','./icon-192.png?v=0.15.6','./icon-512.png?v=0.15.6','./wozzaworld-logo.png?v=0.15.6'];
