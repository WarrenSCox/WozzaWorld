const CACHE='wozzaworld-v0.14.7';
const LOCAL=['./','./index.html','./styles.css?v=0.14.7','./app.js?v=0.14.7','./manifest.webmanifest?v=0.14.7','./icon.svg?v=0.14.7','./icon-192.png?v=0.14.7','./icon-512.png?v=0.14.7','./wozzaworld-logo.png?v=0.14.7'];
