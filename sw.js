const CACHE='wozzaworld-v0.14.4';
const LOCAL=['./','./index.html','./styles.css?v=0.14.4','./mountain-bg.jpg?v=0.14.4','./app.js?v=0.14.4','./manifest.webmanifest?v=0.14.4','./icon.svg?v=0.14.4','./icon-192.png?v=0.14.4','./icon-512.png?v=0.14.4','./wozzaworld-logo.png?v=0.14.4'];
