...
const LOCAL=['./','./index.html','./styles.css?v=0.9.1','./app.js?v=0.9.1','./manifest.webmanifest?v=0.9.1','./icon.svg?v=0.9.1','./icon-192.png?v=0.9.1','./icon-512.png?v=0.9.1','./wozzaworld-logo.png?v=0.9.1'];
