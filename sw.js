const CACHE='wozzaworld-v0.16.3';
const LOCAL=['./','./index.html','./styles.css?v=0.16.3','./app.js?v=0.16.3','./manifest.webmanifest?v=0.16.3','./icon-192.png?v=0.16.3','./icon-192.png?v=0.16.3','./icon-512.png?v=0.16.3','./wozzaworld-logo.png?v=0.16.3','./cloud-a.svg?v=0.16.3','./cloud-b.svg?v=0.16.3'];
