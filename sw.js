const CACHE='wozzaworld-v0.14.8';
const LOCAL=['./','./index.html','./styles.css?v=0.14.8','./app.js?v=0.14.8','./manifest.webmanifest?v=0.14.8','./icon.svg?v=0.14.8','./icon-192.png?v=0.14.8','./icon-512.png?v=0.14.8','./wozzaworld-logo.png?v=0.14.8'];
