const CACHE='wozzaworld-v0.16.7';
const LOCAL=['./','./index.html','./styles.css?v=0.16.7','./app.js?v=0.16.7','./manifest.webmanifest?v=0.16.7','./icon-192.png?v=0.16.7','./icon-192.png?v=0.16.7','./icon-512.png?v=0.16.7','./wozzaworld-logo.png?v=0.16.7','./cloud-a.svg?v=0.16.7','./cloud-b.svg?v=0.16.7'];
