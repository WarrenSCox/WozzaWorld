const CACHE='wozzaworld-v0.17.1';
const LOCAL=['./','./index.html','./styles.css?v=0.17.1','./app.js?v=0.17.1','./manifest.webmanifest?v=0.16.8','./icon-192.png?v=0.16.8','./icon-192.png?v=0.16.8','./icon-512.png?v=0.16.8','./wozzaworld-logo.png?v=0.16.8','./cloud-a.svg?v=0.16.8','./cloud-b.svg?v=0.16.8'];
