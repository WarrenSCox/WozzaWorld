const CACHE='wozzaworld-v0.16.1';
const LOCAL=['./','./index.html','./styles.css?v=0.16.1','./app.js?v=0.16.1','./manifest.webmanifest?v=0.16.1','./icon-192.png?v=0.16.1','./icon-192.png?v=0.16.1','./icon-512.png?v=0.16.1','./wozzaworld-logo.png?v=0.16.1','./cloud-a.svg?v=0.16.1','./cloud-b.svg?v=0.16.1'];
