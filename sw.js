const CACHE='wozzaworld-v0.16.4';
const LOCAL=['./','./index.html','./styles.css?v=0.16.4','./app.js?v=0.16.4','./manifest.webmanifest?v=0.16.4','./icon-192.png?v=0.16.4','./icon-192.png?v=0.16.4','./icon-512.png?v=0.16.4','./wozzaworld-logo.png?v=0.16.4','./cloud-a.svg?v=0.16.4','./cloud-b.svg?v=0.16.4'];
