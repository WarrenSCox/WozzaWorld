const CACHE='wozzaworld-v0.15.5';
const LOCAL=['./','./index.html','./styles.css?v=0.15.5','./app.js?v=0.15.5','./manifest.webmanifest?v=0.15.5','./icon-192.png?v=0.15.5','./icon-192.png?v=0.15.5','./icon-512.png?v=0.15.5','./wozzaworld-logo.png?v=0.15.5'];
