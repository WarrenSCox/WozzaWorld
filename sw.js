const CACHE='wozzaworld-v0.14.3';
const LOCAL=['./','./index.html','./styles.css?v=0.14.3','./mountain-bg.svg?v=0.14.3','./app.js?v=0.14.3','./manifest.webmanifest?v=0.14.3','./icon.svg?v=0.14.3','./icon-192.png?v=0.14.3','./icon-512.png?v=0.14.3','./wozzaworld-logo.png?v=0.14.3'];
