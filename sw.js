const CACHE='wozzaworld-v0.16.2';
const LOCAL=['./','./index.html','./styles.css?v=0.16.2','./app.js?v=0.16.2','./manifest.webmanifest?v=0.16.2','./icon-192.png?v=0.16.2','./icon-192.png?v=0.16.2','./icon-512.png?v=0.16.2','./wozzaworld-logo.png?v=0.16.2','./cloud-a.svg?v=0.16.2','./cloud-b.svg?v=0.16.2'];
