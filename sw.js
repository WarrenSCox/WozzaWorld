const CACHE='wozzaworld-v0.14.5';
const LOCAL=['./','./index.html','./styles.css?v=0.14.5','./mountain-bg.jpg?v=0.14.5','./app.js?v=0.14.5','./manifest.webmanifest?v=0.14.5','./icon.svg?v=0.14.5','./icon-192.png?v=0.14.5','./icon-512.png?v=0.14.5','./wozzaworld-logo.png?v=0.14.5'];
