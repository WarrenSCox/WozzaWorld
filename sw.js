const CACHE='wozzaworld-v06';
const LOCAL=['./','./index.html','./styles.css?v=0.6','./app.js?v=0.6','./manifest.webmanifest?v=0.6','./icon.svg?v=0.6','./icon-192.png?v=0.6','./icon-512.png?v=0.6'];
