const CACHE='wozzaworld-v0.14.2';
const LOCAL=['./','./index.html','./styles.css?v=0.14.2','./app.js?v=0.14.2','./manifest.webmanifest?v=0.14.2','./icon.svg?v=0.14.2','./icon-192.png?v=0.14.2','./icon-512.png?v=0.14.2','./wozzaworld-logo.png?v=0.14.2'];
