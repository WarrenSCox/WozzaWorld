const CACHE='wozzaworld-v0.15.4';
const LOCAL=['./','./index.html','./styles.css?v=0.15.4','./app.js?v=0.15.4','./manifest.webmanifest?v=0.15.4','./icon-192.png?v=0.15.4','./icon-192.png?v=0.15.4','./icon-512.png?v=0.15.4','./wozzaworld-logo.png?v=0.15.4'];
