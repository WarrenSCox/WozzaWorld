const CACHE='wozzaworld-v0.16.0';
const LOCAL=['./','./index.html','./styles.css?v=0.16.0','./app.js?v=0.16.0','./manifest.webmanifest?v=0.16.0','./icon-192.png?v=0.16.0','./icon-192.png?v=0.16.0','./icon-512.png?v=0.16.0','./wozzaworld-logo.png?v=0.16.0','./cloud-a.svg?v=0.16.0','./cloud-b.svg?v=0.16.0'];
