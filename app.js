...
.trip-card-meta-row{min-width:0!important;flex-wrap:nowrap!important;overflow:visible!important}.trip-card-meta-row .trip-travel-icons,.trip-card-meta-row .trip-vibe-icons{display:inline-flex!important;align-items:center!important;gap:7px!important;flex:0 0 auto!important;white-space:nowrap!important}.trip-card-meta-row .trip-travel-icons>span,.trip-card-meta-row .trip-vibe-icons>span{flex:0 0 auto!important}.trip-card-meta-row [hidden]{display:none!important}.trip-icon-viewport{height:28px;overflow:hidden;display:inline-flex;align-items:center;flex:0 0 auto;margin-left:0;mask-image:linear-gradient(to right,transparent 0,#000 7px,#000 calc(100% - 7px),transparent 100%);-webkit-mask-image:linear-gradient(to right,transparent 0,#000 7px,#000 calc(100% - 7px),transparent 100%)}.trip-icon-track{display:inline-flex;align-items:center;gap:7px;white-space:nowrap;will-change:transform;transition:transform .72s cubic-bezier(.22,.61,.36,1)}.trip-icon-track>span{display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto}.trip-icon-track .travel-mode-icon,.trip-icon-track .vibe-icon{width:24px;height:24px;object-fit:contain;display:block}@media (prefers-reduced-motion:reduce){.trip-icon-track{transition:none!important}}
