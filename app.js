...
function countryKey(c){const aliases={'Dominican Rep.':'Dominican Republic'};c=aliases[c]||c;const code=flags[c];return code?code:String(c||'').trim().toLowerCase().replace(/[^a-z0-9]+/g,' ')}
