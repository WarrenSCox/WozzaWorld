...
function itineraryWhen(item){const d=item.startDate?pretty(item.startDate):'Anytime',t=item.flexible?'Flexible timing':(item.startTime||'');return [d,t].filter(Boolean).join(' · ')}
