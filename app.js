...
.trip-card-meta-row{min-width:0!important;flex-wrap:nowrap!important;overflow:visible!important}.trip-card-meta-row .trip-travel-icons,.trip-card-meta-row .trip-vibe-icons{display:inline-flex!important;align-items:center!important;gap:7px!important;flex:0 0 auto!important;white-space:nowrap!important}.trip-card-meta-row .trip-travel-icons>span,.trip-card-meta-row .trip-vibe-icons>span{flex:0 0 auto!important}.trip-card-meta-row [hidden]{display:none!important}.trip-icon-viewport{height:28px;overflow:hidden;display:inline-flex;align-items:center;flex:0 0 auto;margin-left:0}.trip-icon-track{display:inline-flex;align-items:center;gap:7px;white-space:nowrap}.trip-icon-flap-slot{width:24px;height:28px;display:inline-flex;align-items:center;justify-content:center;overflow:hidden;perspective:70px;flex:0 0 24px}.trip-icon-flap-inner{width:24px;height:24px;display:inline-flex;align-items:center;justify-content:center;transform-origin:50% 50%;backface-visibility:hidden}.trip-icon-flap-inner>span{display:inline-flex;align-items:center;justify-content:center;width:24px;height:24px}.trip-icon-track .travel-mode-icon,.trip-icon-track .vibe-icon{width:24px;height:24px;object-fit:contain;display:block}.trip-icon-flap-inner.is-flipping{animation:wozzaIconFlap .38s cubic-bezier(.3,.7,.2,1) var(--flap-delay,0ms) both}@keyframes wozzaIconFlap{0%{transform:rotateX(0);filter:none}42%{transform:rotateX(-88deg);filter:brightness(.75)}55%{transform:rotateX(82deg);filter:brightness(.75)}100%{transform:rotateX(0);filter:none}}@media (prefers-reduced-motion:reduce){.trip-icon-flap-inner.is-flipping{animation:none!important}}
