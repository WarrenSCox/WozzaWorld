...
(()=>{if(document.getElementById('wozza-trip-editor-icon-grid-10'))return;const st=document.createElement('style');st.id='wozza-trip-editor-icon-grid-10';st.textContent=`#tripDialog .trip-editor-date-range{display:flex!important;flex-direction:column!important;align-items:stretch!important;gap:12px!important}#tripDialog .trip-editor-date{display:block!important;width:100%!important}#tripDialog .trip-editor-icon-grid{display:grid!important;grid-template-columns:repeat(10,minmax(0,1fr))!important;gap:10px 8px!important;width:100%!important;align-items:center!important}#tripDialog .trip-editor-icon-grid img{width:24px!important;height:24px!important;object-fit:contain!important;display:block!important;justify-self:center!important}`;document.head.appendChild(st)})();
