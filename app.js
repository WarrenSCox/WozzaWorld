...
async function showSection(target){
 ...
 if(!reduce){
   ...
   Object.assign(veil.style,{position:'fixed',inset:'0',zIndex:'2147483646',pointerEvents:'none',opacity:'0',background:(bg&&bg!=='rgba(0, 0, 0, 0)')?bg:'#078b98',transition:'opacity 180ms ease'});
