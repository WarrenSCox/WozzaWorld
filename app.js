...
function updateCountryLabels(transform){
 ...
 if(!portrait){
  ...
  labels.each(function(d){
   ...
   d3.select(this).attr('x',pt[0]).attr('y',pt[1]-(d.name==='Croatia'?(transform.k>=12?50:34):0)).style('display',show?null:'none')
  });
  return
 }
 const k=transform.k;
