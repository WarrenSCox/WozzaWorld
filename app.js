...
const TRAVEL_MODES=['Plane','Car','Campervan','Motorhome','Train','Ferry','Cruise','Narrowboat','Coach / Bus','Motorbike','Bicycle','On foot','Other'];
