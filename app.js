...
function tripFlapIcons(t){
  ...
  return `<div class="trip-flap-icons" data-trip-flap="${esc(t.id||'')}" data-flap-items="${encodeURIComponent(JSON.stringify(items))}" aria-label="Travel methods and trip vibes: ${esc(items.map(x=>x.label).join(', '))}"></div>`;
}
function tripAdaptiveFlags(cs){
  ...
  return `<div class="trip-card-flags" data-flag-items="${encodeURIComponent(JSON.stringify(items))}" aria-label="Trip countries"></div>`;
}
(function setupAdaptiveTripFooter(){
  ...
  const st=document.createElement('style');st.id='wozza-adaptive-trip-footer-style';st.textContent=`
    ...
    #tripList .trip-card-meta-row{display:flex!important;align-items:center!important;gap:9px!important;width:100%!important;min-width:0!important;padding-right:0!important;box-sizing:border-box!important}
    ...
    #tripList .trip-flap-icons{flex:1 1 auto!important;min-width:28px!important;display:flex!important;align-items:center!important;gap:4px!important;overflow:hidden!important;perspective:240px!important}
    ...
    #tripList .trip-card-flags{position:static!important;transform:none!important;flex:0 1 auto!important;width:auto!important;max-width:112px!important;min-width:34px!important;margin:0!important;display:flex!important;align-items:center!important;justify-content:flex-end!important;overflow:hidden!important;gap:5px!important;perspective:240px!important}
    ...
    #tripList .trip-card-flags[data-count="4"]{width:112px!important;gap:0!important}
    #tripList .trip-card-flags[data-count="4"] .trip-flag-slot+ .trip-flag-slot{margin-left:-8px}
    #tripList .trip-card-flags[data-count="5"],#tripList .trip-card-flags[data-count="6"],#tripList .trip-card-flags[data-count="7"],#tripList .trip-card-flags[data-count="8"],#tripList .trip-card-flags[data-count="9"]{width:112px!important;gap:0!important}
    ...
    @media(max-width:420px){#tripList .trip-card-meta-row{gap:7px!important}#tripList .trip-card-flags{max-width:92px!important}#tripList .trip-card-flags[data-count="3"],#tripList .trip-card-flags[data-count="4"],#tripList .trip-card-flags[data-count="5"],#tripList .trip-card-flags[data-count="6"],#tripList .trip-card-flags[data-count="7"],#tripList .trip-card-flags[data-count="8"],#tripList .trip-card-flags[data-count="9"]{width:92px!important}#tripList .trip-card-flags[data-count="3"] .trip-flag-slot+ .trip-flag-slot{margin-left:-5px}#tripList .trip-card-flags[data-count="4"] .trip-flag-slot+ .trip-flag-slot{margin-left:-14px}#tripList .trip-card-flags[data-count="5"] .trip-flag-slot+ .trip-flag-slot,#tripList .trip-card-flags[data-count="6"] .trip-flag-slot+ .trip-flag-slot,#tripList .trip-card-flags[data-count="7"] .trip-flag-slot+ .trip-flag-slot,#tripList .trip-card-flags[data-count="8"] .trip-flag-slot+ .trip-flag-slot,#tripList .trip-card-flags[data-count="9"] .trip-flag-slot+ .trip-flag-slot{margin-left:-20px}}
