...
(function(){
  ...
  function travelScoreData(){
    ...
    const evidence={
      ...
      momentum:`${e.trips.length} completed ${e.trips.length===1?'trip':'trips'} · travel recorded across ${e.years.size} ${e.years.size===1?'year':'years'} · never decays with inactivity = 10 points`,
