...
/* Trip editor summary hotfix: fresh per-trip icon state + one continuous wrapping row. */
(function(){
 if(document.getElementById('wozza-trip-editor-summary-row-fix'))return;
 const st=document.createElement('style');st.id='wozza-trip-editor-summary-row-fix';st.textContent=`
 #tripForm .trip-editor-date-range{display:flex!important;align-items:center!important;align-content:center!important;gap:10px!important;flex-wrap:wrap!important;width:100%!important}
 #tripForm .trip-editor-date-text{flex:0 0 auto!important}
 #tripForm .trip-editor-summary-icons{display:contents!important}
 #tripForm .trip-editor-date-range .travel-mode-icon,#tripForm .trip-editor-date-range .vibe-icon{width:24px!important;height:24px!important;object-fit:contain!important;display:block!important;flex:0 0 24px!important}
 `;document.head.appendChild(st);
})();
