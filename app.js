...
.trip-card-meta-row{min-width:0!important;flex-wrap:nowrap!important;overflow:visible!important}.trip-card-meta-row .trip-travel-icons,.trip-card-meta-row .trip-vibe-icons{display:inline-flex!important;align-items:center!important;gap:7px!important;flex:0 0 auto!important;white-space:nowrap!important}.trip-card-meta-row .trip-travel-icons>span,.trip-card-meta-row .trip-vibe-icons>span{flex:0 0 auto!important}.trip-card-meta-row [hidden]{display:none!important}.trip-meta-overflow{appearance:none;border:0;background:transparent;padding:0 2px;margin:0 0 0 1px;min-width:31px;height:28px;display:inline-flex;align-items:center;justify-content:center;flex:0 0 auto;font:800 14px/1 system-ui,-apple-system,BlinkMacSystemFont,"Segoe UI",sans-serif;color:#101211;cursor:pointer;white-space:nowrap}.trip-meta-overflow:focus-visible{outline:2px solid currentColor;outline-offset:2px;border-radius:6px}
